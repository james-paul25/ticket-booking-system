...
const schema = z.object({
  ...
  address: z.string().min(3, "Please enter your city or address"),
          ...
          {done ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 animate-fade-drop delay-150" noValidate>
                ...
                <div>
                  <label htmlFor="reg-address" className="block text-xs font-semibold text-slate-600 mb-1 tracking-wide">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Tagbilaran City, Bohol"
                      {...register("address")}
                    />
                  </div>
                  {errors.address && (
