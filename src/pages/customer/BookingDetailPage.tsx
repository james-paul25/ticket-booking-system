...
export function BookingDetailPage() {
  ...
  return (
    <div className="max-w-4xl lg:max-w-5xl mx-auto space-y-5 animate-fade-in px-2 py-2">
      <Link
        to="/bookings"
      ...
      <div className="card p-6 sm:p-7 space-y-6 shadow-sm border-slate-200 dark:border-slate-800">
        ...
        {/* Responsive Details: Horizontal on Desktop (grid lg:grid-cols-12), Vertical on Phones */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          {/* Left Column: Voyage Transit & Seat Info (7 cols on desktop) */}
          ...
          {/* Right Column: Fare Breakdown, Pass Button, & Cancellation (5 cols on desktop) */}
          <div className="lg:col-span-5 space-y-4">
            <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-2.5 text-xs">
              ...
              {booking.cancelled_at && (
                <div className="p-3 rounded-xl bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-900 text-red-700 dark:text-red-300 text-xs mt-2">
            ...
            <div className="pt-1">
              <Link
                ...
                className="btn-primary w-full text-xs !py-3 font-black flex items-center justify-center gap-2 shadow-xs"
              >
